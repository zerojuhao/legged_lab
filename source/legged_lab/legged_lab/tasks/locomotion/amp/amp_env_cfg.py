...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandwithZeroProbCfg(
        asset_name="robot",
        ...
        heading_control_stiffness=0.5,
        debug_vis=True,
        ranges=mdp.UniformVelocityCommandwithZeroProbCfg.Ranges(
            lin_vel_x=(-0.1, 0.1), lin_vel_y=(-0.1, 0.1), ang_vel_z=(-0.1, 0.1), zero_prob=(0.05, 0.05, 0.05), heading=(-math.pi, math.pi)
        ),
    )
...
class AnimationCfg:
    ...
    animation = AnimTerm(
        ...
        random_fetch=True,
        resample_motion_on_update=True,
        enable_visualization=False,
        velocity_blend_ratio =0.8,
    )
